      ...
      this.validateOptions = function(ops) {
          for (var prop in ops) {
              if (self.defaults.hasOwnProperty(prop)) {
                  self.defaults[prop] = ops[prop]; // 값 할당
              }
          }
      };

      this.wrapperDamper = this.defaults.wrapperDamper; // 값 할당
      this.wrapperId = this.defaults.wrapperId; // 값 할당
      this.cancelOnTouch = this.defaults.cancelOnTouch; // 값 할당
      this.wrapper = null; // null로 초기화
